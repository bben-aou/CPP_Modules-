...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/18 10:09:44 by virsnp00x         #+#    #+#             */
/*   Updated: 2022/12/24 08:09:20 by bben-aou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::~ClapTrap(){
    std::cout << RED "ClapTrap Destructor has been called !" RESET << std::endl;
}
...
void ClapTrap::attack(std::string const &target){
    ...
    if (this->hitPoint == 0)
        std::cout << RED " has no more hit point !" RESET << std::endl;
    else
